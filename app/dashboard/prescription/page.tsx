  ...
  return (
    <>
      ...
      <main className="flex-1 p-8">
        <PrescriptionClient
          data={data}
          clinicName={clinicSettings?.clinic_name || process.env.NEXT_PUBLIC_CLINIC_NAME || 'My Clinic'}
          doctorName={clinicSettings?.doctor_name || process.env.NEXT_PUBLIC_DOCTOR_NAME || 'Doctor'}
          clinicPhone={clinicSettings?.clinic_phone || process.env.NEXT_PUBLIC_CLINIC_PHONE || ''}
          clinicAddress={clinicSettings?.clinic_address || process.env.NEXT_PUBLIC_CLINIC_ADDRESS || ''}
