            ...
            return (<div className="space-y-4 mt-4">
              ...
              <div className="card p-5">
                ...
                <div className="grid grid-cols-3 gap-4 mb-4">
                  {([{l:'0–30 Days',it:a0,c:'#f59e0b',bg:'#fefce8'},{l:'31–60 Days',it:a31,c:'#ea580c',bg:'#fff7ed'},{l:'60+ Days',it:a60,c:'#dc2626',bg:'#fef2f2'}] as any[]).map((b:any)=>(
                ...
                {out.length>0&&(<div>
                  ...
                  <div className="space-y-2">
                    {([...out] as any[]).sort((a:any,b:any)=>Math.max(0,b.feeAmount-b.discount-b.paid)-Math.max(0,a.feeAmount-a.discount-a.paid)).slice(0,8).map((inv:any,i:number)=>{
                      const due=Math.max(0,inv.feeAmount-inv.discount-inv.paid);
