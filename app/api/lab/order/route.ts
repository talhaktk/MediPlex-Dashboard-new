...
// POST — create a new lab/radiology order
export async function POST(req: NextRequest) {
  ...
  const { mrNumber, patientName, dob, orderType, tests, clinicalNotes } = body;
  ...
  return NextResponse.json({ ok: true, orderId: data.id, qrToken: data.qr_token, expiresAt: data.qr_expires_at });
}
